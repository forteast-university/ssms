...
namespace App.Service.Business
{
    ...
    {
        private readonly IRepository<KichCo> product;

        public KichCoService(IRepository<KichCo> product, IDataProvider data, IDbContext db)
        {
        ...
        {
            var query = from a in product.Table where a.MaCo != MaCo select a;
