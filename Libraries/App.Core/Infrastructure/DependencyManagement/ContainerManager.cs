...
// ***********************************************************************
// <copyright file="ContainerManager.cs" company="Thanh Dong University">
...
namespace ADA.Core.Infrastructure.DependencyManagement
{
    ...
    public class ContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new AppException("Unknown dependency");
            ...
            throw new AppException("No constructor  was found that had all the dependencies satisfied.");
        }
